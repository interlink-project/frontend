            ...
            >
              <Paper sx={{ backgroundColor: 'background.paper' }}>
                ...
                >
                  ...
                  {!editMode ? <Typography variant='h5'>{team.name}</Typography> : (
                    <TextField
                      autoFocus
                      margin='dense'
                      id='name'
                  ...
                  {!editMode ? <Typography variant='body1'>{team.description}</Typography> : (
                    <TextField
                      margin='dense'
                      id='description'
                      label='Description'
            ...
            >
              ...
              >
                ...
                <Tab
                  ...
                  label={`${t('Administrators')} (${team.administrators_ids.length})`}
                />
              </Tabs>
              {tabValue === 'members' && (
                <UsersList

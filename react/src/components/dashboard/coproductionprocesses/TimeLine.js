  ...
  return (
    <Box sx={{ p: 3, justifyContent: 'center' }}>
      ...
      >
        ...
        >
          <StepLabel>
            <Stack spacing={1}>
              ...
              <Button
                onClick={() => navigate(`/dashboard/coproductionprocesses/${process.id}/settings`)}
                size='small'
                variant='contained'
                sx={{ maxWidth: '200px' }}
              >
        ...
        <Step
          active
          completed={administratorsFulfilled}
        >
          <StepLabel>
            <Stack spacing={1}>
              <Typography variant='subtitle1'>
              ...
              {administratorsFulfilled
                ? (
                  <Alert severity='success'>
                    {t('The administrators of the coproduction process data has been defined.')}
                    {' '}
                    (
                    {process.administrators_ids.length}
                    {' '}
                    {t('administrators')}
                    )
                  </Alert>
        ...
        <Step
          active
          completed={permissionsFullfilled}
        >
          <StepLabel>
            <Stack spacing={1}>
              <Typography variant='subtitle1'>
